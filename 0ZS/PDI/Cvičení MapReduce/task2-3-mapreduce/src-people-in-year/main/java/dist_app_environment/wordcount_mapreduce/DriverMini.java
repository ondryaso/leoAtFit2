...
public class DriverMini {
    ...
    private final static Path DFS_INPUT_DIR = new Path("wordcount/input");
    private final static Path DFS_OUTPUT_DIR = new Path("wordcount/output");
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length < 2) {
            System.err.println("Usage: wordcount <local_in> [<local_in>...] <local_out>");
            System.exit(2);
        }
        // cluster start
        ...
        // job
        final Job job = WordCount.createJob(conf);
